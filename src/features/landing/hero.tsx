    ...
    <>
      ...
      >
        <div className="relative isolate flex flex-col">
              ...
              <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-center lg:gap-20">
                ...
                <div className="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
                  ...
                  <h1 className="text-foreground text-4xl font-bold tracking-tight text-balance sm:text-5xl lg:text-6xl lg:leading-tight">
                    Jeremy Prat{" "}
                    <span className="text-orange-500">Coaching Personnel</span>
                  </h1>

                  {/* Sous-titre */}
                  <p className="text-muted-foreground mt-6 max-w-xl text-base leading-relaxed sm:text-lg">
                    Allier entraînement rigoureux et nutrition équilibrée pour
                  ...
                  <div className="mt-10 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                    ...
                    <Link
                      href="/team"
                      target="_blank"
                      className="border-border text-foreground hover:bg-muted inline-flex items-center gap-2 rounded-md border px-8 py-3.5 text-sm font-semibold transition-all"
                    >
                  ...
                  {/* Badges inline */}
                  <div className="text-muted-foreground mt-8 hidden flex-wrap items-center justify-center gap-6 text-sm md:flex lg:justify-start">
                ...
                <div className="flex w-full shrink-0 justify-center lg:w-auto lg:justify-end">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 -z-10 scale-110 rounded-md bg-gradient-to-tr from-orange-300/30 to-purple-300/20 blur-md" />
                    <Image
          ...
          {/* ── Stats bar ── */}
          <div className="md:content border-border bg-muted/30 hidden border-t">
            <div className="mx-auto max-w-4xl px-6 py-6 lg:max-w-6xl lg:px-8">
